...
{
    public sealed class CurrentAccountCollectionAgingImportResult
    {
    ...
    public static class CurrentAccountCollectionAgingImportService
    {
        public static CurrentAccountCollectionAgingImportResult Import(
            ...
            long defaultBankAccountId)
        {
            ...
            {
                return new CurrentAccountCollectionAgingImportResult
                {
        ...
        public static CurrentAccountCollectionAgingImportResult ImportSelectedRows(
            BusinessObjectBase businessObject,
            DateTime reportDate,
            long defaultBankAccountId,
        ...
        {
            var result = new CurrentAccountCollectionAgingImportResult();
            ...
            {
                result.Message = SLanguage.GetString("Alacak bakiye kolonu bulunamadı.");
                return result;
            }
            ...
            long bankAccountId = CurrentAccountAgingImportService.ResolveDefaultBankAccountId(
                session,
                defaultBankAccountId,
        ...
        {
            PlanningAmountSide.ApplyAmountToRow(
                itemRow,
                BankReceiptCollectionOrderHelper.ReceiptType,
                amount,
                null);
        ...
        static string BuildExplanation(string accountName, DateTime reportDate)
        {
            return string.Format(
                SLanguage.GetString("{0} - {1}/{2} Alacak Yaşlandırma"),
                accountName,
        ...
        static string BuildResultMessage(CurrentAccountCollectionAgingImportResult result, bool needsDefaultBankAccount)
        {
            ...
            if (result.SkippedZeroAmountCount > 0)
            {
                AppendMessageLine(
                    message,
                    string.Format(
                        SLanguage.GetString("{0} cari için alacak bakiye bulunamadı."),
                        result.SkippedZeroAmountCount));
            }
