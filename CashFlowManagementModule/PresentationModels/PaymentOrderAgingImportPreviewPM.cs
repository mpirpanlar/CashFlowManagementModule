...
{
    public class PaymentOrderAgingImportPreviewPM : PMDesktop
    {
        DataTable _agingData;
        string _amountColumnName;
        PaymentOrderAgingImportContext _context;
        ...
        public PaymentOrderAgingImportPreviewPM(IContainerExtension container) : base(container)
        {
        }

        public void Initialize(
            PaymentOrderAgingImportContext context,
        ...
        public override void LoadCommands()
        {
            ...
            CmdList.AddCmd(320, "ImportSelectedAgingCommand", SLanguage.GetString("Aktar"), OnImportSelectedAgingCommand, null);
        }

        public override void _view_Loaded(object sender, RoutedEventArgs e)
        {
            base._view_Loaded(sender, e);
            PmTitle = SLanguage.GetString("Yaşlandırma Önizleme");
            LoadAgingData();
        }
        ...
        void OnImportSelectedAgingCommand(ISysCommandParam param)
        {
            ...
            {
                SysMng.Instance.ActWndMng.ShowMsg(
                    SLanguage.GetString("<= 0 yaşlandırma kolonu bulunamadı."),
                    ConstantStr.Warning);
                return;
            }
