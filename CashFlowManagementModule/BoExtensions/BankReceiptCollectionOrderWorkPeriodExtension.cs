...
{
    public class BankReceiptCollectionOrderWorkPeriodExtension : BoExtensionBase
    {
        ...
        public BankReceiptCollectionOrderWorkPeriodExtension(BusinessObjectBase bo)
            : base(bo)
        {
        }
        ...
        protected override void OnPreBeforePost(object sender, CancelEventArgs e)
        {
            ...
            ExpandWorkPeriodIfCollectionOrder();
        }
        ...
        bool IsCollectionOrderReceipt()
        {
            return BankReceiptCollectionOrderHelper.IsCollectionOrderReceipt(BusinessObject);
        }
        ...
        void ExpandWorkPeriodIfCollectionOrder()
        {
            if (!IsCollectionOrderReceipt() || _isWorkPeriodExpanded) return;
